...
module.exports = {
	 ...
	 */
	createVolumeSlider : function(originx,originy,width,height,colorMinimum,colorMaximum) {
 		exec(null, null, "VolumeSlider","createVolumeSlider", [originx, originy, width, height, colorMinimum, colorMaximum]);
 	},
